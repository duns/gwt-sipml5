...
public class StackConfig extends JavaScriptObject {
	...
	public native final void setEventsHandler(String mask,
			...
			var callbackFunc = function(e) {
				var ev = @org.sipml5.gwt.sipml5.event.StackEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
				callback.@org.sipml5.gwt.sipml5.handler.IStackEventHandler::onEvent(Lorg/sipml5/gwt/sipml5/event/StackEvent;)(ev);
			};
